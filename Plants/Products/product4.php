    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="product4.php"</script>';
            }else{
...
<body>
    ...
    <br>
        ...
        <?php
            $query = "SELECT * FROM product where id = 25 ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="product4.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 968</del></h6>
                    <h3>&#8377; 699</h3>
                    <h4><a href="product1.php">Top 4 Die Hard Succulents Pack</a></h4>
            ...
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 1,193</del></h6>
                    <h3>&#8377; 799</h3>
                    <h4><a href="product2.php">Set of 3 Outdoor Flowering Plants</a></h4>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 1,204</del></h6>
                    <h3>&#8377; 849</h3>
                    <h4><a href="product3.php">Top 4 Plants For Healthy Homes</a></h4>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 1,356</del></h6>
                    <h3>&#8377; 949</h3>
                    <h4><a href="product4.php">Best 4 plants to Kill Indoor Pollution</a></h4>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
            ...
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 1,491</del></h6>
                    <h3>&#8377; 999</h3>
                    <h4><a href="product5.php">Special 4 Plants Pack</a></h4>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
