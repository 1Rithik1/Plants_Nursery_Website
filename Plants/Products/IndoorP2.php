    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="IndoorP2.php"</script>';
            }else{
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="IndoorP2.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            ...
            <div class="products">
                ...
                <div class="content">
                    <h6><del>&#8377; 1,356</del></h6>
                    <h3>&#8377; 949</h3>
                    <h4><a href="product4.html">Best 4 plants to Kill Indoor Pollution</a></h4>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
