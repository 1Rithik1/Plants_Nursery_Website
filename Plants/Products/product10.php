    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="product10.php"</script>';
            }else{
...
<body>
    ...
    <br>
        ...
        <?php
            $query = "SELECT * FROM product where id = 31 ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="product10.php?action=add&id=<?php echo $row["id"]; ?>">
