    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="BonsaiP3.php"</script>';
            }else{
    ...
    <br>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="BonsaiP3.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                        <a href="BonsaiP1.php">
                        <div class="img">
                           <img src="BonsaiP1.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 799</del></h6>
                            <h3>&#8377; 699</h3>
                            <h4><a href="BonsaiP1.php">Ficus Bonsai - Plant</a></h4>
                    ...
                    <div class="products">
                        <a href="BonsaiP2.php">
                        <div class="img">
                           <img src="BonsaiP2.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 1,849</del></h6>
                            <h3>&#8377; 1,749</h3>
                            <h4><a href="BonsaiP2.php">Ficus microcarpa Bonsai- Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="products">
                        <a href="BonsaiP3.php">
                        <div class="img">
                           <img src="BonsaiP3.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 849</del></h6>
                            <h3>&#8377; 799</h3>
                            <h4><a href="BonsaiP3.php">Ficus Bonsai and Laughing Buddha</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
