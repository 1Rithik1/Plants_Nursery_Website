    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="FlowersP2.php"</script>';
            }else{
...
<body>
    ...
    <br>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="FlowersP2.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                        <a href="FlowersP1.php">
                        <div class="img">
                           <img src="FlowersP1.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 549</del></h6>
                            <h3>&#8377; 499</h3>
                            <h4><a href="FlowersP1.php">Plumeria, Champa (Any Color) - Plant</a></h4>
                    ...
                    <div class="products">
                        <a href="FlowersP2.php">
                        <div class="img">
                           <img src="FlowersP2.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 599</del></h6>
                            <h3>&#8377; 499</h3>
                            <h4><a href="FlowersP2.php">Plumeria, Champa (White) - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="products">
                        <a href="FlowersP3.php">
                        <div class="img">
                           <img src="FlowersP3.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 549</del></h6>
                            <h3>&#8377; 499</h3>
                            <h4><a href="FlowersP3.php">Plumeria, Champa (Yellow) - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
