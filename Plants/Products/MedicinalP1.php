    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="MedicinalP1.php"</script>';
            }else{
...
<body>
    ...
    <br>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="MedicinalP1.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                        <a href="MedicinalP1.php">
                        <div class="img">
                           <img src="MedicinalP1.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 299</del></h6>
                            <h3>&#8377; 249</h3>
                            <h4><a href="MedicinalP1.php">Aloe vera - Succulent Plant</a></h4>
                    ...
                    <div class="products">
                        <a href="MedicinalP2.php">
                        <div class="img">
                           <img src="MedicinalP2.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 349</del></h6>
                            <h3>&#8377; 299</h3>
                            <h4><a href="MedicinalP2.php">Piper Betel, Maghai Paan - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="products">
                        <a href="MedicinalP3.php">
                        <div class="img">
                           <img src="MedicinalP3.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 349</del></h6>
                            <h3>&#8377; 299</h3>
                            <h4><a href="MedicinalP3.php">Lemon Grass - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
