    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="FruitsP1.php"</script>';
            }else{
    ...
    <br>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="FruitsP1.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                        <a href="FruitsP1.php">
                        <div class="img">
                           <img src="FruitsP1.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 399</del></h6>
                            <h3>&#8377; 329</h3>
                            <h4><a href="FruitsP1.php">Badam Tree, Indian Almond Tree- Plant</a></h4>
                    ...
                    <div class="products">
                        <a href="FruitsP2.php">
                        <div class="img">
                           <img src="FruitsP2.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 399</del></h6>
                            <h3>&#8377; 329</h3>
                            <h4><a href="FruitsP2.php">Mango Tree (Grown through seeds) - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="products">
                        <a href="FruitsP3.php">
                        <div class="img">
                           <img src="FruitsP3.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 549</del></h6>
                            <h3>&#8377; 499</h3>
                            <h4><a href="FruitsP3.php">Orange Fruit, Santra ( Grafted ) - Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
