    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="CactusP2.php"</script>';
            }else{
    ...
    <br>
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                        <form method="post" action="CactusP2.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <div class="selling">
            <div class="products">
                        <a href="CactusP1.php">
                        <div class="img">
                           <img src="CactusP1.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 399</del></h6>
                            <h3>&#8377; 299</h3>
                            <h4><a href="CactusP1.php">Acanthocereus tetragonus - Cactus Plant</a></h4>
                    ...
                    <div class="products">
                        <a href="CactusP2.php">
                        <div class="img">
                           <img src="CactusP2.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 399</del></h6>
                            <h3>&#8377; 299</h3>
                            <h4><a href="CactusP2.php">Opuntia monacantha - Cactus Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                    ...
                    <div class="products">
                        <a href="CactusP3.php">
                        <div class="img">
                           <img src="CactusP3.jpg">
                        </div>
                        <div class="content">
                            <h6><del>&#8377; 499</del></h6>
                            <h3>&#8377; 399</h3>
                            <h4><a href="CactusP3.php">Bunny Ear Cactus, Opuntia microdasys - Cactus Plant</a></h4>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
